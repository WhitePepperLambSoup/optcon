...
w(z) = w0 sqrt(1 + (z/zR)^2). The broader resolution sweep is generated by
``docs/generate_figures.py`` and stored as CSV data.
...
def main() -> int:
    ...
    print(
        ...
        "closed form much more closely. The resolution sweep is generated by "
        "docs/generate_figures.py and is stored in docs/data."
    )
    return 0
